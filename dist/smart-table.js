  ...
  .directive('stSort', ['stConfig', '$parse', function (stConfig, $parse) {
    return {
      ...
      link: function (scope, element, attr, ctrl) {
        ...
        var index = 0;
        var classBoth = attr.stClassBoth || stConfig.sort.bothWaysClass;
